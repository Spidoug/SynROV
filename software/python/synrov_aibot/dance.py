...
from .protocol import DANCE_SCHEMA, SOFTWARE_VERSION
from .safety import MANIPULATOR_HOME_POSE
...
class AdaptiveDanceModel:
    ...
    def _robot(robot: Any) -> str:
        # Rhythm actuation exists only for Manipulator.
        return "Manipulator"
    ...
    def _load(self) -> None:
        ...
        try:
            ...
            return
        if not isinstance(raw, dict) or raw.get("schema") != DANCE_SCHEMA or raw.get("softwareVersion") != SOFTWARE_VERSION:
            return
