...
class SynROVOrchestrator:
    ...
    def _decision(self, allowed: bool, src: str, reason: str, priority: int, lock_s: float, **metadata: Any) -> ActionDecision:
    ...
    def action_allowed(
        ...
        *,
        ...
        voice_intent = _norm(ctx.get("intent", "none")) or "none"
        try:
        ...
        prior_src = _source_group(last_command_source if last_command_source is not None else self.state.last_command_source)
