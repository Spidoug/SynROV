...
void initMotorState() {
  motor.kp = 5.9f;   // DC PWM 70%: rastreamento geral de referência
  motor.ki = 0.000f;
  motor.kd = 0.90f;
...
// Utility: decode stored motor drive mode.
MotorDriveMode decodeStoredMotorDriveMode(uint8_t rawMode) {
  ...
  switch (rawMode) {
    case 0: return MOTOR_MODE_HALFSTEP_UNIPOLAR;
    case 1: return MOTOR_MODE_HALFSTEP_BIPOLAR;
    case 2: return MOTOR_MODE_FULLSTEP_UNIPOLAR;
    case 3: return MOTOR_MODE_HALFSTEP_UNIPOLAR;
    default: return MOTOR_MODE_HALFSTEP_UNIPOLAR;
  }
}
