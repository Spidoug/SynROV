...
Run the dedicated WebSocket runtime without the Tkinter UI. This keeps the bridge connected in passive mode; add `--loop` to execute mission ticks continuously:
