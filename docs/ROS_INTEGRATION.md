...
Processing centralizes ROS integration in `software/processing/SynROV/RosIntegration.pde`. The bridge uses rosbridge WebSocket so the Processing application does not depend on native ROS Java bindings.
