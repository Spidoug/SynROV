...
// Utility: decode the V1 stored motor drive mode.
...
// Utility: decode the V1 stored motor type.
...
// Loads the V1 robot control mode record from EEPROM.
...
// Saves the V1 robot control mode record to EEPROM.
